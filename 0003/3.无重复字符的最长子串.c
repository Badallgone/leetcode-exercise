...
/*
 *Accepted
 *988/988 cases passed (3 ms)
 *Your runtime beats 51.19 % of c submissions
 *Your memory usage beats 77.82 % of c submissions (9.5 MB)
*/
...
1. 角色分工
    ...
    map (记事本)：记录当前窗口里已经有哪些字符了（布尔值表示存在或不存在）。
